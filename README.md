...
## 💡 A Solução
Uma aplicação simples de Linha de Comando (CLI) que atua como um "Monitor de Bateria Social". O usuário pode registrar seu nível atual de energia (1 a 10). O sistema salva esse histórico e retorna dicas instantâneas de como adequar sua rotina (foco em tarefas isoladas vs. trabalho em equipe) com base no seu nível de energia atual.

**Público-alvo:** Profissionais, estudantes, neurodivergentes e pessoas lidando com limites de interação social.
